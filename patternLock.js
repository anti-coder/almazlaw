...
mhnUI = {
   ...
   lock: function() {
        mhnUI.page.hide(), pattern = new PatternLock(".mhn-lock", {
            ...
            $(".mhn-lock-title").html('<span class="mhn-lock-failure"><br>Буква М не получилась, попробуйте еще раз!<br><h3 style="line-height: 1px; opacity: 0;">***************************************************** *************************************************</h3></span>'), $(".patt-holder").removeClass("patt-success"), setTimeout(function() {
                pattern.reset(), mhnUI.message()
            }, 2e3)
        })
    },
